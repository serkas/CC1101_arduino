...
On Oct 22, 2016 10:07 PM, "Simon Monk" <srmonk@gmail.com> wrote:
	...
	ELECHOUSE_CC1101_ESP32 library in a 'recipe'. Your library is by far the easiest to use of 
...
*/
#include "ELECHOUSE_CC1101_ESP32.h"
...
*OUTPUT       :none
****************************************************************/
void ELECHOUSE_CC1101_ESP32::SpiInit(void)
{
    ...
    // From Arduino: SPI Master, MSB, SPI mode 0, FOSC/4
...
****************************************************************/
byte ELECHOUSE_CC1101_ESP32::SpiTransfer(byte value)
{
    return vspi->transfer(value);
}
...
*OUTPUT       : none
****************************************************************/
void ELECHOUSE_CC1101_ESP32::GDO_Set (void)
{
	pinMode(GDO0, INPUT);
}
...
*OUTPUT       :none
****************************************************************/
void ELECHOUSE_CC1101_ESP32::Reset (void)
{
...
*OUTPUT       :none
****************************************************************/
void ELECHOUSE_CC1101_ESP32::Init(void)
{
...
*OUTPUT       :none
****************************************************************/
void ELECHOUSE_CC1101_ESP32::Init(byte f)
{
	SpiInit();										//spi initialization
	GDO_Set();										//GDO set
	digitalWrite(SS_PIN, HIGH);
 ...
 */
void ELECHOUSE_CC1101_ESP32::Sleep(bool powerDown)
{
    if ( powerDown ) {
 ...
 */
void ELECHOUSE_CC1101_ESP32::WakeUp()
{
    digitalWrite(SS_PIN, LOW);
    delay(1);
    digitalWrite(SS_PIN, HIGH);
 ...
 * Wake the CC1101 from sleep state
 */
void ELECHOUSE_CC1101_ESP32::SetPATable(byte paTable[])
{
...
*OUTPUT       :none
****************************************************************/
void ELECHOUSE_CC1101_ESP32::SpiWriteReg(byte addr, byte value)
{
	digitalWrite(SS_PIN, LOW);
	while(digitalRead(MISO_PIN));
	SpiTransfer(addr);
...
*OUTPUT       :none
****************************************************************/
void ELECHOUSE_CC1101_ESP32::SpiWriteBurstReg(byte addr, byte *buffer, byte num)
{
	byte i, temp;
...
*OUTPUT       :none
****************************************************************/
void ELECHOUSE_CC1101_ESP32::SpiStrobe(byte strobe)
{
	digitalWrite(SS_PIN, LOW);
	while(digitalRead(MISO_PIN));
	SpiTransfer(strobe);
...
****************************************************************/
byte ELECHOUSE_CC1101_ESP32::SpiReadReg(byte addr) 
{
	byte temp, value;
...
*OUTPUT       :none
****************************************************************/
void ELECHOUSE_CC1101_ESP32::SpiReadBurstReg(byte addr, byte *buffer, byte num)
{
	byte i,temp;
...
*OUTPUT       :status value
****************************************************************/
byte ELECHOUSE_CC1101_ESP32::SpiReadStatus(byte addr) 
{
	byte value,temp;
...
*OUTPUT       :none
****************************************************************/
void ELECHOUSE_CC1101_ESP32::RegConfigSettings(byte f) 
{
...
*OUTPUT       :none
****************************************************************/
void ELECHOUSE_CC1101_ESP32::SendData(byte *txBuffer,byte size)
{
...
*OUTPUT       :none
****************************************************************/
void ELECHOUSE_CC1101_ESP32::SetReceive(void)
{
...
****************************************************************/
byte ELECHOUSE_CC1101_ESP32::CheckReceiveFlag(void)
{
...
****************************************************************/
byte ELECHOUSE_CC1101_ESP32::ReceiveData(byte *rxBuffer)
{
	byte size;
	byte status[2];
...
ELECHOUSE_CC1101_ESP32 ELECHOUSE_cc1101;
